 ...
 ?>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
      <div class="owl-carousel header-carousel position-relative">
        <?php 
          $selb="SELECT * FROM banners ORDER BY ban_id DESC LIMIT 0,4";
            ...
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-10 col-lg-8">
                  <h1 class="display-2 text-white animated slideInDown"><?= $banner['ban_title']; ?></h1>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                 <?php 
                  ...
                  while($services=mysqli_fetch_assoc($Qs)){
                 ?>
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded overflow-hidden">
                        <img class="img-fluid" src="admin/uploads/<?= $services['service_image']; ?>" alt="">
                        <div class="position-relative p-4 pt-0">
                             <div class="service-icon">
                                <i class="<?= $services['service_icon']; ?>"></i>
                            </div>
                            <h4 class="mb-3"><?= $services['service_title']; ?></h4>
